  ...
  <div class="flex min-h-screen flex-col bg-slate-950 text-white">
    ...
    <main class="flex flex-1 flex-col gap-6 p-4">
      ...
      <div v-else class="grid flex-1 gap-4 lg:grid-cols-3">
        ...
        <div class="space-y-4">
          <QuizClient v-if="quiz" :question="quiz.question" :choices="quiz.choices" :multi="quiz.multi"
            :time-limit="quiz.timeLimit" @submit="handleQuiz" />
          <ScratchCard
...
import PixelStage from '../components/PixelStage.client.vue'
import ConnectionIndicator from '../components/ConnectionIndicator.vue'
import QuizClient from '../components/ui/QuizClient.vue'
import ScratchCard from '../components/ui/ScratchCard.client.vue'
import BeatGame from '../components/ui/BeatGame.client.vue'
import { useWs } from '../plugins/ws.client'
import { useSequencer } from '../composables/useSequencer'
import { useRenderer } from '../composables/useRenderer'
import { useAppState } from '../stores/appState'
import { useGameBus } from '../composables/useGameBus'
import { useAddressing, type ClientContext } from '../composables/useAddressing'
